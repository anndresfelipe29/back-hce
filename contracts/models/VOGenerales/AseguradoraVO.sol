...
contract AseguradoraVO{
    ...
    function getAseguradoraVOValue() public view returns (AseguradoraVOStruct memory) {
        return AseguradoraVOStruct(
            id,
            nombre,
            estaActivo
        );
    ...
    function setValueOfAseguradoraVOStruct(AseguradoraVOStruct memory aseguradoraVOStruct) public {
